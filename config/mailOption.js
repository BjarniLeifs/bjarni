...
module.exports = {
	...
	'projectName'  					: ' á vefsíðu name.',
	'emailSubject' 					: 'Beðni um að breyta lykilorði notanda ',
	'greeting' 						: 'Hæ ',
	'contentMailToken'  			: ' þú hefur fengið þennan póst vegna þess að þú (eða einhver annar) hefur beðið um að breyta lykilorði hjá þér á aðgangi þínum. \n\n Vinsamlegast smelltu á slóð hér að neðan, eða afritaðu þessa slóð í vafra til að breyta lykilorði. \n\n',
	'contentMailReportChangePass' 	: ' þú hefur fengið þennan póst vegna þess að þú (eða einhver annar) hefur beðið um að breyta lykilorði hjá þér á aðgangi þínum. \n\n Lykilorðið þitt hefur verið uppfært\n\n Ef þú kannast ekki við að hafa uppfært lykilorðið þitt, þá vinsamlegast hafðu samband við stjórnanda.\n',
	'regards'						: 'Kær kveðja \n Vefstjóri.'
};
